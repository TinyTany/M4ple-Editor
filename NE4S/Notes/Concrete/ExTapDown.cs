...
{
    [Serializable()]
    public sealed class ExTapDown : AirableNote
    {
        public override NoteType NoteType => NoteType.ExTapDown;

        private ExTapDown() { }

        public ExTapDown(int size, Position pos, PointF location, int laneIndex) 
